...
``` fxml
         ...
         <AnchorPane prefHeight="33.0" prefWidth="269.0">
            <children>
               <Button fx:id="increaseFontSizeButton" mnemonicParsing="false" onAction="#handleIncreaseFontSizeButton" prefWidth="38.0" text="+" AnchorPane.rightAnchor="113.0" AnchorPane.topAnchor="0.0" />
               <Button fx:id="decreaseFontSizeButton" layoutX="58.0" mnemonicParsing="false" onAction="#handleDecreaseFontSizeButton" text="-" AnchorPane.bottomAnchor="2.0" AnchorPane.rightAnchor="58.0" AnchorPane.topAnchor="0.0" />
               <Button fx:id="resetFontSizeButton" defaultButton="true" layoutX="113.0" mnemonicParsing="false" onAction="#handleResetFontSizeButton" text="R" AnchorPane.rightAnchor="0.0" AnchorPane.topAnchor="0.0" />
            </children>
         </AnchorPane>
```
