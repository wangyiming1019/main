...
A list of my contributions to Address++ are explained below:
...
Many users have security related concerns. In order to prevent malicious access
to users' Address++ application, the password protection suite of commands were
created.
