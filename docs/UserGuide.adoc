...
A task can have the following 5 priorities: `1 2 3 4 5`, where 5 represents the highest priority +
...
Adds a tag to people in the address book. +
Format: `addtag INDEX... t/TAG ` +
Shorthand commands: `atag`

****
* Adds the tag to the person at the specified `INDEX`
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* 1, 2, 3, ...
* If no indexes are specified, addtag will add the tag to all existing contacts in the address book.
****
...
* `list` +
`addtag t/friends 1` +
Adds the friends tag of the 1st person in the address book.
* `list` +
`addtag t/friends` +
Adds the friends tag to everyone in the address book.
...
* `edit task 2 p/1` +
Edits the priority of the 2nd task to be `1`.
...
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* 1, 2, 3, ...
* If no indexes are specified, deletetag will delete this tag from all contacts in the address book.
****

Examples:

* `list` +
`deletetag t/friends 1` +
Delete the friends tag of the 1st person in the address book.
* `list` +
`deletetag t/friends` +
Delete the friends tag from everyone in the address book.
...
Clears all person/task entries from the address book. +
Format (person): `clear` +
Format (task):  `clear task` +
Format (all): `clear all` +
...
* *Add tag* : `addtag [TAG] INDEX` +
e.g. `addtag friends 2`
* *Clear person* : `clear`
* *Clear tasks* : `clear `
* *Clear all* : `clear all`
...
e.g. `delete task 4`
* *Delete tag* : `deletetag [TAG] INDEX` +
e.g. `deletetag friends 1`
