...
Format: `add n/NAME p/[PHONE_NUMBER] e/[EMAIL] a/[ADDRESS] b/[BIRTHDAY] r/[REMARK] v/[AVATAR] f/[FACULTY] c/[GOOGLE CALENDAR URL] [t/TAG]...` +
...
`add n/Ima Hidearu b/ a/ e/ p/ r/ v/ t/secretive`
****
****
**Example Scenario 3** +
...
=== Exporting the data
[NOTE]
This is not available in version 1.5rc. It will be available in future releases
...
The program will learn your typing habits and give autocomplete suggestions.
