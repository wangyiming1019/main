...
Format: `add n/NAME p/[PHONE_NUMBER] e/[EMAIL] a/[ADDRESS] c/[GOOGLE CALENDAR URL] [t/TAG]...`
...
Format: `edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] c/[GOOGLE CALENDAR URL] [t/TAG]...`
