...
You can back up your saved data on Address++ by using the `backup` command.
...
* *Add person with private fields* : `a pn/[NAME] pp/[PHONE_NUMBER] pe/[EMAIL] pa/[ADDRESS] pr/[REMARK] [t/TAG]...` +
