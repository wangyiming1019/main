...
_Figure 3.4.1 : Sequence Diagram for changing the privacy of a Person's fields_
...
_Figure 3.5.1 : Sequence Diagram for Locating a Person's Address_
...
_Figure 3.6.1 : Sequence Diagram for Navigating from one Address to another_
...
_Figure 3.7.1 : Sequence Diagram for Opening a save file_
