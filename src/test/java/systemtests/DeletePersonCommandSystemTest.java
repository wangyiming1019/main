...
import static seedu.address.logic.commands.DeletePersonCommand.MESSAGE_SUCCESS;
...
public class DeletePersonCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        String expectedResultMessage = String.format(MESSAGE_SUCCESS, deletedPerson);
        ...
        expectedResultMessage = String.format(MESSAGE_SUCCESS, deletedPerson);
    ...
    /**
     * Deletes the person at {@code toDelete} by creating a default {@code DeletePersonCommand} using
