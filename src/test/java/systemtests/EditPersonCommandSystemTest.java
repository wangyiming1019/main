...
public class EditPersonCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() throws Exception {
        ...
        editedPerson = new PersonBuilder(personToEdit).withTags(VALID_TAG_FRIEND).withRemark(VALID_REMARK_BOB).build();
        assertCommandSuccess(command, index, editedPerson);
    ...
    public void editFourth() throws Exception {
        ...
        //TODO rewrite GUI check for this as select no longer displays google searches
     ...
     * @see EditPersonCommandSystemTest#assertCommandSuccess(String, Index, ReadOnlyPerson, Index)
     */
    ...
    private void assertCommandSuccess(String command, Index toEdit, ReadOnlyPerson editedPerson,
        ...
        assertCommandSuccess(command, expectedModel,
                String.format(EditPersonCommand.MESSAGE_SUCCESS, editedPerson), expectedSelectedCardIndex);
    }
